...
const BlanketDrive: React.FC = () => {
  ...
  return (
    <section id="blanket-drive" className="mb-24 dark:bg-gray-950 dark:text-gray-100">
      {/* Hero */}
        ...
        <div className="relative z-10 px-8 py-16 md:py-20">
          <div className="max-w-5xl mx-auto grid md:grid-cols-2 gap-12 items-center">
            ...
            <div className="relative">
              <ImagePlaceholder text="Blanket Distribution Image" width="100%" height="300px" className="rounded-xl shadow-2xl border-4 border-white/20 dark:border-gray-700" />
            </div>
          </div>
        </div>
      </div>
