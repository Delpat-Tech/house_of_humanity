          ...
          <div className="max-w-5xl mx-auto grid md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-xl text-yellow-100 mb-8 leading-relaxed">
                Spreading warmth and dignity to Vadodara’s homeless during the coldest nights of the year.
              </p>
            ...
            <div className="relative">
              <ImagePlaceholder text="Blanket Distribution Image" width="100%" height="300px" className="rounded-xl shadow-2xl border-4 border-white/20" />
            </div>
          </div>
        </div>
      </div>
          ...
          {[
            {
              ...
              description: "Provide blankets to those sleeping on the streets during winter nights.",
              icon: "🧤",
            },
            {
              title: "Volunteer Engagement",
              description: "Volunteers act as Santas, spreading festive cheer and warmth.",
              icon: "🎅",
            },
            {
              title: "Focus on Vulnerable",
              description: "Identify and reach the most exposed and vulnerable across the city.",
              icon: "❤️",
            },
          ].map((item, idx) => (
            <div
            ...
            >
              ...
              <h4 className="text-xl font-bold text-red-600 mb-4">{item.title}</h4>
      ...
      <div className="bg-gradient-to-br from-orange-50 to-red-100 rounded-2xl p-8 md:p-12 mb-12">
        <div className="text-center mb-12">
          ...
          <p className="text-lg text-dark-gray max-w-3xl mx-auto">
            Over 3,000 individuals reached in 3 years, receiving not just blankets but dignity and care during cold nights.
          </p>
        </div>
        <div className="grid grid-cols-2 md:grid-cols-3 gap-6">
          {stats.map((stat, index) => (
            ...
            >
              ...
              <div className="text-3xl font-bold text-red-700 mb-2">{stat.number}</div>
