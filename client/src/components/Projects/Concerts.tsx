...
const Concerts: React.FC = () => {
  ...
  return (
    <section id="concerts" className="mb-24">
      {/* Hero */}
      <div className="relative overflow-hidden bg-gradient-to-br from-indigo-500 via-purple-600 to-pink-500 rounded-2xl mb-16">
          ...
          <div className="max-w-5xl mx-auto grid md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <h1 className="text-4xl md:text-5xl font-extrabold text-white mb-6 leading-tight">
                Project
                <span className="block text-pink-100 text-5xl md:text-6xl mt-2">Concerts</span>
              </h1>
