        ...
        <div className="relative z-10 px-8 py-16 md:py-20">
          <div className="max-w-5xl mx-auto grid md:grid-cols-2 gap-12 items-center">
            ...
            <div className="relative">
              <ImagePlaceholder text="Concert Stage and Crowd" width="100%" height="300px" className="rounded-xl shadow-xl border-4 border-white/20 dark:border-gray-700" />
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="bg-white rounded-2xl shadow-xl p-8 md:p-12 my-16 dark:bg-gray-900 dark:border dark:border-gray-700">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            ...
            <div className="relative">
              <ImagePlaceholder text="Audience enjoying live concert" width="100%" height="250px" className="rounded-xl shadow-lg dark:border-gray-700" />
            </div>
          </div>
        </div>
      </div>
        ...
        <div className="grid md:grid-cols-2 gap-8 text-center">
          {whatWeDo.map((item, idx) => (
            ...
            >
              ...
              <h4 className="text-xl font-bold text-purple-700 mb-4 dark:text-purple-200">{item.title}</h4>
        ...
        <div className="grid grid-cols-2 md:grid-cols-3 gap-6">
          {stats.map((stat, index) => (
            ...
            >
              ...
              <div className="text-3xl font-bold text-purple-700 mb-2 dark:text-purple-200">{stat.number}</div>
