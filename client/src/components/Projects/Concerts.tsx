...
const Concerts: React.FC = () => {
  ...
  const whatWeDo = [
    {
      ...
      description:
        "Organize events that combine entertainment with awareness and social inclusion.",
      icon: "🎭",
    },
    {
  ...
  return (
    <section id="concerts" className="mb-24 dark:text-gray-100">
      {/* Hero */}
          ...
          <div className="max-w-5xl mx-auto grid md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <h1 className="text-4xl md:text-5xl font-extrabold text-white mb-6 leading-tight dark:text-pink-200">
                Project
                <span className="block text-pink-100 text-5xl md:text-6xl mt-2 dark:text-purple-200">
                  Concerts
                </span>
              </h1>
              <p className="text-xl text-pink-100 mb-8 leading-relaxed dark:text-purple-100">
                Fusing entertainment with empathy — bringing music, dance, and
                joy to every corner of the community.
              </p>
      ...
      <div className="bg-white rounded-2xl shadow-xl p-8 md:p-12 my-16">
        <div className="max-w-4xl mx-auto">
          <div className="text-center mb-12">
            <h2 className="text-3xl md:text-4xl font-bold text-primary-blue mb-6 dark:text-purple-200">
              About Project Concerts
            </h2>
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              <p className="text-lg text-dark-gray leading-relaxed mb-6 dark:text-gray-200">
                Project Concerts creates space for joy, unity, and
                celebration—by organizing large-scale cultural events and
                ensuring inclusivity for underprivileged communities. Whether
              ...
              <div className="bg-gradient-to-r from-purple-50 to-pink-100 rounded-lg p-6 dark:from-gray-700 dark:to-pink-900/40">
                ...
                <p className="text-primary-blue font-semibold text-lg dark:text-purple-100">
                  To democratize access to culture and joy through concerts that
                  uplift, unite, and inspire.
                </p>
              </div>
            </div>
            <div className="relative">
      ...
      <div className="bg-gradient-to-br from-warm-light-blue/20 to-fresh-green/20 rounded-2xl p-8 md:p-12 mb-12">
        <div className="text-center mb-12">
          ...
          <p className="text-lg text-dark-gray max-w-3xl mx-auto dark:text-gray-200">
            Through 3 major concerts including Garba Night and King Live, we’ve
            reached over 7,000 people and enabled 150+ slum children to
