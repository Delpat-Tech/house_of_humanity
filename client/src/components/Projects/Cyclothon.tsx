...
const Cyclothon: React.FC = () => {
  ...
  return (
    <section id="cyclothon" className="mb-24">
          ...
          <div className="max-w-5xl mx-auto grid md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <h1 className="text-4xl md:text-5xl font-extrabold text-white mb-6 leading-tight">
                Project
                <span className="block text-cyan-100 text-5xl md:text-6xl mt-2">Cyclothon</span>
              </h1>
            ...
            <div className="relative">
              <ImagePlaceholder text="Cyclothon Event" width="100%" height="300px" className="rounded-xl shadow-xl border-4 border-white/20" />
            </div>
          </div>
        </div>
      </div>
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <div className="bg-gradient-to-r from-green-50 to-blue-100 rounded-lg p-6">
                <h4 className="font-semibold mb-2 text-green-800">Our Vision</h4>
            ...
            <div className="relative">
              <ImagePlaceholder text="Cyclothon Riders" width="100%" height="250px" className="rounded-xl shadow-lg" />
            </div>
          </div>
        </div>
      </div>
        ...
        <div className="grid md:grid-cols-2 gap-8 text-center">
          {whatWeDo.map((item, idx) => (
            ...
            >
              ...
              <h4 className="text-xl font-bold text-cyan-700 mb-4">{item.title}</h4>
      ...
      {/* Impact */}
      <div className="bg-gradient-to-br from-blue-50 to-green-100 rounded-2xl p-8 md:p-12 mb-12">
        <div className="text-center mb-12">
