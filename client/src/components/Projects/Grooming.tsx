...
const Grooming: React.FC = () => {
  ...
  return (
    <section id="grooming" className="mb-24">
      {/* Hero */}
      <div className="relative overflow-hidden bg-gradient-to-br from-pink-500 via-rose-400 to-purple-500 rounded-2xl mb-16">
