...
const Marathon: React.FC = () => {
  ...
  return (
    <section id="marathon" className="mb-24">
          ...
          <div className="max-w-5xl mx-auto grid md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <h1 className="text-4xl md:text-5xl font-extrabold text-white mb-6 leading-tight">
                Project
                <span className="block text-orange-100 text-5xl md:text-6xl mt-2">Marathon</span>
              </h1>
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <div className="bg-gradient-to-r from-orange-50 to-pink-100 rounded-lg p-6">
                <h4 className="font-semibold text-red-800 mb-2">Our Mission</h4>
      ...
      {/* Impact */}
      <div className="bg-gradient-to-br from-orange-50 to-pink-100 rounded-2xl p-8 md:p-12 mb-12">
        <div className="text-center mb-12">
