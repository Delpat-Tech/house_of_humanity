            ...
            <div className="space-y-12">
              {[
                ...
                },
                {
                  ...
                  description:
                    "The lack of access can lead to social isolation of girls.",
                  image: "Social impact visualization",
                },
                {
                  step: "03",
                  title: "School Dropout",
                  description:
                    "Girls miss school and even drop out of school due to lack of proper menstrual hygiene products and education.",
                ...
                },
                {
                  ...
                  description:
                    "Long-held taboos around menstruation need to be addressed through community outreach and education.",
                  image: "Cultural barriers",
                },
              ].map((matter, index) => (
                <div
                  key={index}
