...
export const impactData: ImpactItem[] = [
  {
    ...
    number: "30+",
    impact:
      "30 women empowered through composting. Community awareness on sustainable farming increased."
  },
  {
    icon: "female", 
    project: "Pad House",
  ...
  },
  {
    ...
    number: "2500+",
    impact:
      "Blood units donated in 8 camps, 230 volunteers. Emergency cases assisted on-call through donor registry."
  },
  {
    icon: "handsHelping", 
    project: "Sahara",
