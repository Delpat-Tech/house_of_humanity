            ...
            <div className="space-y-4">
              <div className="flex items-start space-x-3">
                <div className="p-2 bg-warm-light-blue rounded-lg backdrop-blur-sm">
                  <MapPin className="w-5 h-5 text-primary-blue dark:text-fresh-green" />
                </div>
              ...
              <div className="flex items-center space-x-3">
                <div className="p-2 bg-warm-light-blue rounded-lg backdrop-blur-sm">
                  <Phone className="w-5 h-5 text-primary-blue dark:text-fresh-green" />
                </div>
                <p className="text-off-white text-sm">+91 99741 91811</p>
              </div>
              <div className="flex items-center space-x-3">
                <div className="p-2 bg-warm-light-blue rounded-lg backdrop-blur-sm">
                  <Mail className="w-5 h-5 text-primary-blue dark:text-fresh-green" />
                </div>
              ...
              {[
                ...
                >
                  <div className="p-2 bg-warm-light-blue rounded-lg backdrop-blur-sm group-hover:bg-fresh-green transition-all duration-200">
                    <Icon className="w-5 h-5 text-primary-blue dark:text-fresh-green group-hover:text-dark-gray" />
                  </div>
