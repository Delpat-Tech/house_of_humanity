          ...
          <div className="bg-white rounded-xl shadow-lg p-8 transform hover:scale-105 transition-transform duration-300">
            ...
            <div className="space-y-6">
              <div className="flex items-start space-x-4">
                ...
                <div>
                  ...
                  <a href="mailto:Info@houseofhumanity.in" className="text-gray-600 hover:text-primary transition-colors">
              ...
              <div className="flex items-start space-x-4">
                ...
                <div>
                  ...
                  <a href="tel:+919974191811" className="text-gray-600 hover:text-primary transition-colors">
                    +91 99741 91811
                  </a>
                </div>
              </div>
            ...
            <div className="mt-8 pt-6 border-t border-gray-200">
              ...
              <div className="flex space-x-4">
                <a href="https://www.facebook.com/houseofhumanityfoundation/" className="bg-primary/10 p-3 rounded-full hover:bg-primary hover:text-white transition-colors group">
                ...
                <a href="https://www.instagram.com/houseofhumanitycharitabletrust/?hl=en" className="bg-primary/10 p-3 rounded-full hover:bg-primary hover:text-white transition-colors group">
                  <svg className="h-6 w-6 text-primary group-hover:text-white" fill="currentColor" viewBox="0 0 24 24">
                ...
                <a href="https://www.linkedin.com/company/house-of-humanity-charitable-trust/?originalSubdomain=in" className="bg-primary/10 p-3 rounded-full hover:bg-primary hover:text-white transition-colors group">
                  <svg className="h-6 w-6 text-primary group-hover:text-white" fill="currentColor" viewBox="0 0 24 24">
          ...
          >
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <button
                ...
                className="w-full bg-primary hover:bg-primary-dark text-white font-medium py-3 px-6 rounded-lg transition duration-300 ease-in-out transform hover:scale-105 disabled:opacity-50 disabled:cursor-not-allowed"
              >
                {isSubmitting ? (
