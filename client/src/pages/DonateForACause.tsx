    ...
    <>
      ...
      <div className="hidden md:flex items-center justify-center w-full max-w-2xl mx-auto gap-6">
        ...
        >
          ...
          <svg className="absolute top-6 left-6 w-10 h-10 text-white opacity-40" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 7h.01M15 7h.01M7 11a5 5 0 015-5h0a5 5 0 015 5v1a5 5 0 01-5 5h-1a5 5 0 01-5-5v-1z" /></svg>
          <img src={testimonials[index].img} alt={testimonials[index].name} className="w-20 h-20 rounded-full mb-4 border-4 border-white shadow-lg ring-4 ring-fresh-green/30" />
