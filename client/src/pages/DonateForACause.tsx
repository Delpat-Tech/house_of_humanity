  ...
  return (
    <>
      ...
      <div className="hidden md:flex items-center justify-center w-full max-w-2xl mx-auto gap-6">
        <button
          onClick={prev}
          className="flex items-center justify-center bg-primary-blue hover:bg-blue-700 text-white rounded-full w-14 h-14 shadow-lg text-3xl z-20 transition-all duration-200 hover:scale-105"
...
00 dark:text-gray-200 text-lg leading-relaxed mb-4 italic"
          ...
          <svg
            className="absolute top-6 left-6 w-10 h-10 text-white opacity-40"
            fill="none"
            viewBox="0 0 24 24"
            stroke="currentColor"
          >
            <path
              ...
              strokeWidth={2}
              d="M9 7h.01M15 7h.01M7 11a5 5 0 015-5h0a5 5 0 015 5v1a5 5 0 01-5 5h-1a5 5 0 01-5-5v-1z"
            />
          </svg>
          <img
            src={testimonials[index].img}
            alt={testimonials[index].name}
            className="w-20 h-20 rounded-full mb-4 border-4 border-white shadow-lg ring-4 ring-fresh-green/30"
          />
          <p className="italic text-2xl text-white font-serif mb-4 text-center leading-relaxed z-10">
            "{testimonials[index].quote}"
          </p>
          <div className="mt-2 text-white/90 font-bold text-lg z-10">
            — {testimonials[index].name}
          </div>
        </motion.div>
        <button
      ...
      <div className="md:hidden w-full max-w-2xl mx-auto">
        ...
        <div className="flex justify-between mt-4 w-full">
          <button
            onClick={prev}
            className="bg-primary-blue hover:bg-blue-700 text-white rounded-full w-12 h-12 flex items-center justify-center shadow-lg text-2xl z-20 transition-all duration-200 hover:scale-105"
            aria-label="Previous testimonial"
          >
            &#8592;
          </button>
  ...
  return (
    <div className="w-full">
        ...
        >
          <div className="flex flex-col items-center mb-6">
            ...
            <p className="text-xl text-white/90 font-medium max-w-2xl">
              ...
              their circumstances. All individual donations are{" "}
              <span className="font-bold text-white">100% matched</span>.
            </p>
          </div>
        </motion.div>
            ...
            <div>
              ...
              <div className="border-2 border-primary-blue/30 p-4 rounded-lg mb-4 bg-primary-blue/5">
                <p>
                  ...
                  <span className="text-primary-blue">₹{amount}</span>
                </p>
                <p>
                  <strong>Giving Frequency:</strong>{" "}
                  <span className="text-primary-blue">One time</span>
                </p>
              </div>
              <div className="border-2 border-primary-blue/30 p-4 rounded-lg mb-4 text-sm bg-primary-blue/5">
                Donate with Stripe Payment Element (placeholder)
              </div>
      ...
      <div className="max-w-5xl mx-auto px-4 mt-20 mb-16">
        <h2 className="text-3xl font-extrabold text-primary-blue mb-8 text-center">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-8">
          {[
            ...
            <div
              key={idx}
              className="bg-white rounded-2xl shadow-xl p-4 flex flex-col items-center text-center border border-primary-blue/20 hover:shadow-2xl transition-all"
            >
              <img
                src={item.img}
                alt={item.title}
                className="rounded-xl mb-4 w-full h-36 object-cover shadow"
              />
