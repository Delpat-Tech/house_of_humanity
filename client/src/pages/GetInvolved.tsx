...
const flipIcons = [
  (
    <svg className="w-10 h-10 text-primary-blue mb-2" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 11c0-1.657-1.343-3-3-3S6 9.343 6 11s1.343 3 3 3 3-1.343 3-3zm0 0c0-1.657 1.343-3 3-3s3 1.343 3 3-1.343 3-3 3-3-1.343-3-3zm0 0v2m0 4v.01" /></svg>
  ),
  (
    <svg className="w-10 h-10 text-fresh-green mb-2" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M8 17l4 4 4-4m0-5V3m-8 9v6a2 2 0 002 2h8a2 2 0 002-2v-6" /></svg>
  ),
  (
    <svg className="w-10 h-10 text-primary-blue mb-2" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 8c-1.657 0-3 1.343-3 3 0 1.657 1.343 3 3 3s3-1.343 3-3c0-1.657-1.343-3-3-3zm0 0V4m0 16v-4m8-4h-4m-8 0H4" /></svg>
  ),
  (
    <svg className="w-10 h-10 text-fresh-green mb-2" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M15 17h5l-1.405-1.405A2.032 2.032 0 0118 14.158V11a6.002 6.002 0 00-4-5.659V5a2 2 0 10-4 0v.341C7.67 6.165 6 8.388 6 11v3.159c0 .538-.214 1.055-.595 1.436L4 17h5m6 0v1a3 3 0 11-6 0v-1m6 0H9" /></svg>
  ),
];
  ...
  return (
    ...
    >
      ...
      >
        {/* Front */}
        <div
          className="absolute w-full h-full flex flex-col items-center justify-center bg-gradient-to-br from-primary-blue via-blue-600 to-fresh-green rounded-2xl shadow-2xl border border-primary-blue/30 group-hover:ring-4 group-hover:ring-primary-blue/30 transition-all"
          style={{
        ...
        {/* Back */}
        <div
          className="absolute w-full h-full flex flex-col items-center justify-center bg-gradient-to-br from-white via-primary-blue/5 to-fresh-green/5 rounded-2xl shadow-xl px-6 text-center border border-primary-blue/20"
          style={{
        ...
        >
          ...
          {cta && (
            <button className="mt-2 bg-gradient-to-r from-primary-blue to-fresh-green hover:from-blue-700 hover:to-green-600 text-white px-4 py-1.5 rounded-lg font-semibold shadow hover:scale-105 transition-transform">{cta}</button>
          )}
        </div>
      </div>
    </motion.div>
  ...
  return (
    <>
      ...
      <div className="hidden md:flex items-center justify-center w-full max-w-2xl mx-auto gap-6">
        <button
          onClick={prev}
          className="flex items-center justify-center bg-primary-blue hover:bg-blue-700 text-white rounded-full w-14 h-14 shadow-lg text-3xl z-20"
        ...
        <motion.div
          ...
          className="bg-gradient-to-br from-primary-blue via-blue-600 to-fresh-green rounded-2xl p-10 shadow-2xl flex flex-col items-center relative overflow-hidden w-full border border-primary-blue/20"
        >
          {/* Decorative Quote Icon */}
          <svg className="absolute top-6 left-6 w-10 h-10 text-white/40" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 7h.01M15 7h.01M7 11a5 5 0 015-5h0a5 5 0 015 5v1a5 5 0 01-5 5h-1a5 5 0 01-5-5v-1z" /></svg>
          <img src={testimonials[index].img} alt={testimonials[index].name} className="w-20 h-20 rounded-full mb-4 border-4 border-white shadow-lg ring-4 ring-white/30" />
          <p className="italic text-2xl text-white font-serif mb-4 text-center leading-relaxed z-10">"{testimonials[index].quote}"</p>
          <div className="mt-2 text-white/90 font-bold text-lg z-10">— {testimonials[index].name}</div>
        </motion.div>
        <button
          onClick={next}
          className="flex items-center justify-center bg-primary-blue hover:bg-blue-700 text-white rounded-full w-14 h-14 shadow-lg text-3xl z-20"
      ...
      <div className="md:hidden w-full max-w-2xl mx-auto">
        <motion.div
          ...
          exit={{ opacity: 0, y: -40, scale: 0.95 }}
          transition={{ duration: 0.5 }}
          className="bg-gradient-to-br from-primary-blue via-blue-600 to-fresh-green rounded-2xl p-8 shadow-2xl flex flex-col items-center relative overflow-hidden w-full border border-primary-blue/20"
        >
          <svg className="absolute top-6 left-6 w-10 h-10 text-white/40" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 7h.01M15 7h.01M7 11a5 5 0 015-5h0a5 5 0 015 5v1a5 5 0 01-5 5h-1a5 5 0 01-5-5v-1z" /></svg>
          <img src={testimonials[index].img} alt={testimonials[index].name} className="w-20 h-20 rounded-full mb-4 border-4 border-white shadow-lg ring-4 ring-white/30" />
          <p className="italic text-2xl text-white font-serif mb-4 text-center leading-relaxed z-10">"{testimonials[index].quote}"</p>
        ...
        <div className="flex justify-between mt-4 w-full">
          <button
            onClick={prev}
            className="bg-primary-blue hover:bg-blue-700 text-white rounded-full w-12 h-12 flex items-center justify-center shadow-lg text-2xl z-20"
            aria-label="Previous testimonial"
          >
            &#8592;
          </button>
...
const GetInvolved = () => {
  ...
  return (
    <div className="max-w-5xl mx-auto py-12 px-4 mt-24">
      ...
      >
        <h2 className="text-3xl font-bold mb-4 text-primary-blue">Volunteer Signup</h2>
        {submitted ? (
          <motion.div
