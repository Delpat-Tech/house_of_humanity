    ...
    <div className="pt-24">
      <section className="bg-gray-100 py-12">
        <div className="container mx-auto px-4">
          <h2 className="text-3xl font-bold text-gray-800 mb-4">Welcome to House of Humanities</h2>
          <p className="text-gray-600 text-lg">
            We are a non-profit organization dedicated to fostering education, healthcare, and sustainable livelihoods for underprivileged communities.
          </p>
        </div>
      </section>
