...
const founders = [
  ...
  {
    name: "Mayank Patel",
    title: "Treasurer & Lead Operations",
    img: "/images/treasurer.jpg",
    intro: `From the very inception of the House of Humanity Charitable Trust, I have been associated with its journey—not as a mere contributor, but as someone deeply invested in its vision to bring meaningful, sustainable change. What began as supporting the cause during its early days has now evolved into my full-time commitment, where every day feels like a blessing. For me, this work isn’t about how the world perceives change; it’s about the change I want to create and the lives I aspire to touch.\n\nWith a Master’s degree in Social Innovation and Entrepreneurship from Tata Institute of Social Sciences (TISS), my academic and professional path has been shaped by the belief that innovation and empathy must go hand in hand. My experience as part of consulting teams for some of the country’s leading CSR initiatives and organizations has equipped me with the expertise to drive strategic, impactful projects.\n\nAt House of Humanity, I serve as Treasurer and Lead Operations, where I not only manage the organization’s financial integrity but also lead the execution of projects across our pillars—Hunger Eradication, Health & Hygiene, Education, Women Empowerment, Sports, and Urban Livelihood. Every initiative is designed with a sense of responsibility and a vision to create lasting transformations, rather than temporary fixes.\n\nI believe that true leadership lies in building something larger than oneself—a movement, a purpose, a legacy. House of Humanity is not just an organization I lead; it’s a reflection of my values, my resilience, and my relentless drive to make change real and tangible.`,
  },
];
