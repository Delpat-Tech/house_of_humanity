                  ...
                  >
                    ...
                    <div className="space-y-6">
                      {[
                        {
                          title: "Our Vision",
                          content: project.content.vision,
                          icon: Target,
                          color: "text-blue-600",
                        },
                        {
                          title: "Our Mission",
                          content: project.content.mission,
                          icon: Rocket,
                          color: "text-purple-600",
                        },
                        {
                          title: "What We Do",
                          content: project.content.whatWeDo,
                          icon: Lightbulb,
                          color: "text-yellow-600",
                        },
                        {
                          title: "Impact Created",
                          content: project.content.impact,
                          icon: Star,
                          color: "text-orange-500",
                        },
                        {
                          title: "Get Involved",
                          content: project.content.getInvolved,
                          icon: Handshake,
