...
const SustainableLivelihood: React.FC = () => {
  ...
  const whatWeDoItems = [
    {
      title: "Develop SHGs",
      description: "Organize women into self-help groups, providing them with the tools and training to work collaboratively.",
      icon: "👥"
    },
    {
      title: "Vermi-Compost Unit",
      description: "Establish and manage a vermi-compost production unit, offering a sustainable source of income and supporting eco-friendly farming practices.",
      icon: "🌱"
    },
    {
      title: "Capacity Building",
      description: "Provide training on financial literacy, compost production, and entrepreneurship, empowering women to take control of their livelihoods.",
      icon: "💡"
    }
  ];
  ...
  const getInvolvedOptions = [
    {
      title: "Support",
      description: "Partner with us to expand Project Sanskruti and empower more women through sustainable livelihood projects.",
      buttonText: "Become a Partner",
      accent: "from-fresh-green to-green-600"
    },
    {
      title: "Volunteer",
      description: "Offer your expertise in training, entrepreneurship, or sustainability to help us further support these women in their journey towards financial independence.",
    ...
    <div className="container mx-auto px-4 py-12 mt-24">
            ...
            <div className="grid md:grid-cols-2 gap-12 items-center">
              <div>
                ...
                <h1 className="text-4xl md:text-5xl font-extrabold text-white mb-6 leading-tight">
                  Project
                  <span className="block text-warm-light-blue text-5xl md:text-6xl">Sanskruti</span>
                </h1>
        ...
        <div className="text-center">
          ...
          <div className="flex flex-wrap justify-center gap-8">
            <div className="bg-white/20 backdrop-blur-sm rounded-lg p-4">
              <img 
                src="/Gallery/Grasim Industries Logo.png"
      ...
      <div className="mb-16">
        <div className="text-center mb-12">
          ...
          <p className="text-lg text-dark-gray max-w-2xl mx-auto">
            Our comprehensive approach focuses on building sustainable livelihoods through community empowerment and environmental stewardship.
          </p>
        </div>
      ...
      <div className="bg-gradient-to-br from-warm-light-blue/20 to-fresh-green/20 rounded-2xl p-8 md:p-12 mb-16">
        <div className="text-center mb-12">
          ...
          <p className="text-lg text-dark-gray max-w-3xl mx-auto">
            Through Project Sanskruti, we have successfully brought together 30 women in Halol Taluka, providing them with meaningful employment opportunities while promoting sustainable practices. The project has fostered economic independence and strengthened the role of women in their communities.
          </p>
        </div>
            ...
            {[
              {
                ...
                description: "Identify and engage with women in Halol Taluka who can benefit from sustainable livelihood opportunities.",
                image: "Community outreach session"
              },
              {
                step: "02",
                title: "SHG Formation",
                description: "Organize women into self-help groups and provide foundational training on collaboration and group dynamics.",
                image: "SHG formation meeting"
              },
              {
                step: "03",
                title: "Skill Development",
                description: "Provide comprehensive training on vermi-compost production, financial literacy, and entrepreneurship.",
                image: "Skills training workshop"
              },
              {
                step: "04",
                title: "Unit Establishment",
                description: "Set up the vermi-compost production unit and provide ongoing support and mentorship.",
      ...
      <div className="mb-16">
        <div className="text-center mb-12">
          ...
          <div className="w-24 h-1 bg-gradient-to-r from-fresh-green to-primary-blue mx-auto mb-6"></div>
          <p className="text-lg text-dark-gray max-w-2xl mx-auto">
            Join us in creating a future where women in rural communities are empowered to lead sustainable livelihoods.
          </p>
        </div>
